...
public class Yuv420spRenderer extends BackgroundRenderer {
	...
	public Yuv420spRenderer() {
		super();

		textureNames = new int[2];
		textureHandles = new int[2];
	...
	public void draw(TrackedImage image) {
		...
		if (inputYLength != yDataLength || inputUVLength != uvDataLength) {
			...
			yDataLength = inputYLength;
			uvDataLength = inputUVLength;
		}
